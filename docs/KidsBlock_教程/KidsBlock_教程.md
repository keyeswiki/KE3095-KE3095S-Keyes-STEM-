...
点击“**执行器**”，分别选中并且添加“**无源蜂鸣器**”，“**直流电机**”和“**舵机**”。
...
![图片不存在](./media/001295b01552104e23f91815e4b4d7b9.png)
...
![图片不存在](./media/215cbf9b633c009bc237c247d427d252.png)
...
| ![图片不存在](media/6a82ee5dd8727ea183dc758cc34e30e0.png) | ![图片不存在](media/f6390b32aa10989da1b7f4ec01d877fa.png)  |![图片不存在](media/278286c09e3e34f820b4754221ac23aa.png)  | ![图片不存在](media/fa9ebfb506b2f154108baba98dffa9ee.jpg) |    
| ------------------------ | ------------------------- | ---------------------------- | ---------------------------- | 
...
向舵机写入一个数值，来直接控制舵机的轴，角度控制。舵机转动到posVal角度值，舵机每隔15毫秒转动一次，角度逐渐添加1°。
...
代码上传成功后，拔下USB线断电。按照接线图正确接好模块后再用USB线连接到计算机上电。4位数码管显示数字，从0000开始，每1秒逐渐到9999。
...
![图片不存在](media/705c83c34c109264c6f7cb46d197074a.png)
...
本项目中使用的代码保存在文件夹“<u>**...\项目代码\KidsBlock_代码**</u>”中，我们可以在此路径下打开代码文件''**39_Weight_Alarm**"。
...
在这一实验课程中我们使用“①”、“②”、“③”、“④”、“⑤”、“⑥”、“⑦”、“⑧”、“⑨”等九个按键来控制SK6812 RGB模块上4个LED灯珠分别亮红色灯、绿色灯、蓝色灯、橙色灯、黄色灯、紫色灯、金色灯、粉红色灯、品红色灯的效果。
...
找到红外遥控器，拔出绝缘片，对准红外接收模块的红外接收传感器的接收头。第一次按下红外遥控器上的 “**<u>▲</u>**” 键，SK6812 RGB模块上4个LED灯珠被点亮，实现开灯的效果。串口监视器打印出按下的按键值和SK6812 RGB模块上4个LED灯珠亮灯情况：“**<u>FF629D  led on</u>**” 。

再次按下红外遥控器上的 “**<u>▼</u>**” 键，SK6812 RGB模块上4个LED灯珠熄灭，实现关灯的效果。串口监视器打印出按下的按键值和SK6812 RGB模块上4个LED灯珠亮灯情况：“**<u>FFA857  led off</u>**” 。
...
| ![图片不存在](media/6a82ee5dd8727ea183dc758cc34e30e0.png)     | ![图片不存在](media/f6390b32aa10989da1b7f4ec01d877fa.png)     |![图片不存在](media/20045f4ff8b1171e01b98d503293b771.png) |
| ---------------------------- | ---------------------------- | ------------------------ |
...
![图片不存在](media/409a24aba9408ad6ae61077440109181.png)
